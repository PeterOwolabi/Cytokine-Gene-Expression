# --- Analysis: IL-1B Gene Expression via qPCR (2^-DDCt Method) ---

# 1. Data Import and Delta Ct Calculation ----
library(readxl)
IL_1B_MREC <- read_excel("C:/Users/PETER/Desktop/Work/IL_1B MREC.xlsx")
View(IL_1B_MREC)
library(dplyr)

# Calculate Delta Ct (Target - Reference)
data <- IL_1B_MREC |>
  mutate(DeltaCt = Ct_target -Ct_reference)  

# 2. Normalization (Delta Delta Ct) and Relative Quantitation (RQ) ----
# Using female/Control as the calibrator group
...
# 5. Post-hoc Letter Assignments (Significance Grouping) ----
...
# 6. Final Visualization (Bar Plot with Error Bars and Letters) ----
library(ggplot2)
plot <- ggplot(group_summary, aes(x = Sex_Diet, y = mean_RQ, fill = Sex_Diet)) +
  ...
  labs(x = "Sex_Diet", y = "Relative Expression(2^-DDCt)", title = "IL_1B Gene Expression by Interaction of Sex and Diet") +
  theme_classic() +
...
# 2. Normalization (Delta Delta Ct) and Relative Quantitation (RQ) ----
# Using F_Alpha/Control as the calibrator group
library(dplyr)
data <- IL_1B_MREC |>
  mutate(DeltaCt = Ct_target -Ct_reference)  
...
plot <- ggplot(group_summary, aes(x = Breed_Diet, y = mean_RQ, fill = Breed_Diet)) +
  ...
  geom_errorbar(aes(ymin = mean_RQ - se_RQ, ymax = mean_RQ +se_RQ), width = 0.2) +
  geom_text(aes(label = Letters, y = mean_RQ + se_RQ + 0.1), size = 6) +
  labs(x = "Breed_Diet", y = "Relative Expression(2^-DDCt)", title = "IL_1B Gene Expression by Interaction of Breed and Diet") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(text = element_text(size = 14), legend.position = "none")
plot
...
# 2. Normalization (Delta Delta Ct) and Relative Quantitation (RQ) ----
# Using F_Alpha/female as the calibrator group
library(dplyr)
data <- IL_1B_MREC |>
  mutate(DeltaCt = Ct_target -Ct_reference)  
...
plot <- ggplot(group_summary, aes(x = Breed_Sex, y = mean_RQ, fill = Breed_Sex)) +
  geom_bar(stat = "identity", color = "black", width = 0.4) +
  geom_errorbar(aes(ymin = mean_RQ - se_RQ, ymax = mean_RQ +se_RQ), width = 0.2) +
  labs(x = "Breed_Sex", y = "Relative Expression(2^-DDCt)", title = "IL_1B Gene Expression by Interaction of Breed and Sex") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(text = element_text(size = 14), legend.position = "none")
plot
...
# 2. Normalization (Delta Delta Ct) and Relative Quantitation (RQ) ----
# Using F_Alpha/female/Control as the calibrator group
...
plot <- ggplot(group_summary, aes(x = Breed_Sex_Diet, y = mean_RQ, fill = Breed_Sex_Diet)) +
  ...
  geom_errorbar(aes(ymin = mean_RQ - se_RQ, ymax = mean_RQ +se_RQ), width = 0.2) +
  geom_text(aes(label = Letters, y = mean_RQ + se_RQ + 0.1), size = 6) +
  labs(x = "Breed_Sex_Diet", y = "Relative Expression(2^-DDCt)", title = "IL_1B Gene Expression by Interaction of Breed and Sex and Diet") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(text = element_text(size = 14), legend.position = "none")
plot
...
# 2. Normalization (Delta Delta Ct) and Relative Quantitation (RQ) ----
# Using F_Alpha as the calibrator group
...
plot <- ggplot(group_summary, aes(x = Breed, y = mean_RQ, fill = Breed)) +
  geom_bar(stat = "identity", color = "black", width = 0.4) +
  geom_errorbar(aes(ymin = mean_RQ - se_RQ, ymax = mean_RQ +se_RQ), width = 0.2) +
  labs(x = "Breed", y = "Relative Expression(2^-DDCt)", title = "IL_1B Gene Expression by Breed") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(text = element_text(size = 14), legend.position = "none")
plot 
...
# 2. Normalization (Delta Delta Ct) and Relative Quantitation (RQ) ----
# Using female as the calibrator group
...
plot <- ggplot(group_summary, aes(x = Sex, y = mean_RQ, fill = Sex)) +
  geom_bar(stat = "identity", color = "black", width = 0.4) +
  geom_errorbar(aes(ymin = mean_RQ - se_RQ, ymax = mean_RQ +se_RQ), width = 0.2) +
  labs(x = "Sex", y = "Relative Expression(2^-DDCt)", title = "IL_1B Gene Expression by Sex") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(text = element_text(size = 14), legend.position = "none")
plot
...
# 2. Normalization (Delta Delta Ct) and Relative Quantitation (RQ) ----
# Using Control as the calibrator group
...
plot <- ggplot(group_summary, aes(x = Diet, y = mean_RQ, fill = Diet)) +
  ...
  geom_errorbar(aes(ymin = mean_RQ - se_RQ, ymax = mean_RQ +se_RQ), width = 0.2) +
  geom_text(aes(label = Letters, y = mean_RQ + se_RQ + 0.1), size = 6) +
  labs(x = "Diet", y = "Relative Expression(2^-DDCt)", title = "IL_1B Gene Expression by Diet") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(text = element_text(size = 14), legend.position = "none")
plot